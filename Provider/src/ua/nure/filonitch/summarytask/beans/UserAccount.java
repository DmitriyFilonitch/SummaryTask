...
public class UserAccount {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + (active_status ? 1231 : 1237);
	...
	public String toString() {
		return "UserAccount [user_id=" + user_id + ", userName=" + userName + ", fullname=" + fullname + ", gender="
				...
				+ ", role_id=" + role_id + ", active_status=" + active_status + ", nameRole=" + nameRole
				+ ", getUser_id()=" + getUser_id() + ", getUserName()=" + getUserName() + ", getFullname()="
				+ getFullname() + ", getGender()=" + getGender() + ", getPassword()=" + getPassword()
				+ ", getBalance()=" + getBalance() + ", isBlock_status()=" + isBlock_status() + ", getRole_id()="
				+ getRole_id() + ", isActive_status()=" + isActive_status() + ", getNameRole()=" + getNameRole()
